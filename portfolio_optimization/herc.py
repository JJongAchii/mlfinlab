...
class HierarchicalEqualRiskContribution:
    ...
    UniqueColors = ['darkred', 'deepskyblue', 
                    'springgreen', 'darkorange', 
                    'deeppink', 'slateblue', 
                    'navy', 'blueviolet',
                    'pink', 'darkslategray']
    ...
    def _get_optimal_number_of_clusters(self, correlation, asset_returns, 
                                        linkage, num_reference_datasets=5):
        """
        ...
        :param asset_returns: (pd.DataFrame) Historical asset returns.
        :param linkage: (str) The type of linkage method to use for clustering.
        :param num_reference_datasets: (int) The number of reference datasets
        to generate for calculating expected inertia.
