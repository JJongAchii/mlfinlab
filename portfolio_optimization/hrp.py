...
class HierarchicalRiskParity:
    ...
    def _quasi_diagnalization(self, num_assets, curr_index):
        """
        Rearrange the assets to reorder them according to 
        hierarchical tree clustering order.
    ...
    def _recursive_bisection(self, covariance, assets):
        """
        Recursively assign weights to the clusters - 
        ultimately assigning weights to the individual assets.
